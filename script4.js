...
document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener("click", function() {
        ...
        const pdfUrl = "cvdl_08.pdf";
        
        // Create an anchor element to trigger the download
        const anchor = document.createElement("a");
        anchor.href = pdfUrl;
        anchor.download = "cvdl_08.pdf";
        anchor.click();
    });
  });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    button.addEventListener("click", function() {
        // Replace this with the URL of your PDF file
        const pdfUrl = "cvdl_09.pdf";
        
        // Create an anchor element to trigger the download
        const anchor = document.createElement("a");
        anchor.href = pdfUrl;
        anchor.download = "cvdl_09.pdf";
        anchor.click();
    });
  });
  document.addEventListener("DOMContentLoaded", function() {
    const button = document.querySelector(".but5");
    button.addEventListener("click", function() {
        // Replace this with the URL of your PDF file
        const pdfUrl = "cvdl_10.pdf";
        
        // Create an anchor element to trigger the download
        const anchor = document.createElement("a");
        anchor.href = pdfUrl;
        anchor.download = "cvdl_10.pdf";
        anchor.click();
    });
  });
